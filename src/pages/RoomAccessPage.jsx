export default function RoomAccessPage() {
  return (
    <div className="wrapper w-full h-[100vh] bg-white lg:p-4">
      <main className="home-page bg-[url(./assets/homepage-bg-img.png)] h-full w-full object-cover flex flex-col items-center justify-center gap-10 bg-no-repeat rounded-md shadow-lg relative">
      <h2 className=" absolute top-0 left-0">Go to Homepage</h2>
